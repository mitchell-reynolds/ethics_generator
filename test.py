# Comment within Karpathy's repo. This is another implementation of their work; possibly optimized
...
def test():
    #open a text file
    data = open('./texts/morals.txt', 'r').read() # should be simple plain text file
    chars = list(set(data))
